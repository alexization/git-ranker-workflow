...
- Current publish status:
  ...
  - PR thread에 `@codex review` trigger comment를 남겼지만 아직 automated review response는 도착하지 않았다.
- Body render check:
...
- PR `#78`에 요청한 automated review response가 도착하면 blocking finding 여부를 triage한다.
